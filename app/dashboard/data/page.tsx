...
export default function DataPage() {
  ...
  const dataPlans = [
    { label: "1GB - ₦300", value: "1gb" },
    { label: "2GB - ₦600", value: "2gb" },
    { label: "5GB - ₦1,500", value: "5gb" },
    { label: "10GB - ₦3,000", value: "10gb" },
  ]
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (typeof window !== "undefined") {
      ...
      if (currentUser.id) {
        ...
        const planLabel = dataPlans.find(p => p.value === selectedPlan)?.label || selectedPlan
        const newTransaction = {
          id: txnId,
          userId: currentUser.id,
          transactionType: "data",
          type: "debit",
          amount: planLabel.split(" - ")[1] || "N/A",
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      {showSuccess && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full text-center space-y-4">
            ...
            <p className="text-gray-700">Your data has been purchased successfully.</p>
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="p-6 max-w-2xl mx-auto space-y-6">
        ...
        {/* Select Data Plan */}
        <div>
          <label className="block text-lg font-semibold text-gray-900 mb-3">Select Data Plan</label>
